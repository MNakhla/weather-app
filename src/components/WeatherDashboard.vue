<template>
  <div class="min-h-screen bg-linear-to-b from-blue-900 via-sky-400 via-75% to-[#EBEBEB] to-75% relative pb-8">
    <WeatherSearch v-model="selectedCity" />

    <Navbar v-model="activeTabId" :cities="cities" />

    <v-container max-width="900" class="mx-auto h-100 px-4 md:px-0 pt-0 pb-16">
...
const activeTabId = ref<number>(cities.value[0].city_id)
